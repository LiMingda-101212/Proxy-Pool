...
```
爬取指定代理,并验证其有效性 -> 检查代理池中的代理有效性 -> 提交到github(本项目)
```
...
请将下方代码复制保存,放到ProxyPool目录下,本程序功能完善,对接github的actions每天更新的代理(本项目)

#### 功能介绍:
下方程序程序用于本地代理管理,支持http/socks4/socks5,有以下几个功能:
...
5. 同步github上的代理池(合并,冲突代理的将以github为准)
